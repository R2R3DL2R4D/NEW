...
async def gib_repo_callback(_, callback_query):
    await callback_query.edit_message_media(
        media=InputMediaVideo("https://telegra.ph/file/ba0abc088e66ee1e72540.mp4", has_spoiler=True),
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaPhoto("https://telegra.ph/file/e57f6352b5ad4a81f3f57.jpg", caption="<b><u>Fᴇᴇʟ Fʀᴇᴇ ᴛᴏ Dᴏɴᴀᴛᴇ</u></b>\n\nUᴘɪ ɪᴅ : btwitsfallen@paytm\nBɪɴᴀɴᴄᴇ ɪᴅ : 549001204"),
    ),
...
async def settings_back_markup(client, CallbackQuery: CallbackQuery, _):
    ...
    if CallbackQuery.message.chat.type == ChatType.PRIVATE:
        ...
        OWNER = OWNER_ID
        image = random.choice(START_IMG_URL)
